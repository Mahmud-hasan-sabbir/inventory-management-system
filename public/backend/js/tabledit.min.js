                    ...
                    toolbar: function() {
                        if (d.editButton || d.deleteButton) {
                            var t = "",
                                ...
                                a = "",
                                s = "";
                            0 === i.find("th.tabledit-toolbar-column").length && i.find("tr:first").append('<th class="tabledit-toolbar-column">Action</th>'), d.editButton && (t = '<button type="button" class="tabledit-edit-button ' + d.buttons.edit["class"] + '" style="float: none;">' + d.buttons.edit.html + "</button>"), d.deleteButton && (e = '<button type="button" class="tabledit-delete-button ' + d.buttons["delete"]["class"] + '" style="float: none;">' + d.buttons["delete"].html + "</button>", s = '<button type="button" class="tabledit-confirm-button ' + d.buttons.confirm["class"] + '" style="display: none; float: none; padding:2px 5px; margin-left:2px;">' + d.buttons.confirm.html + "</button>"), d.editButton && d.saveButton && (n = '<div><button type="button" class="tabledit-save-button ' + d.buttons.save["class"] + '" style="display: none; float: none; padding:2px 5px; margin-left:2px;">' + d.buttons.save.html + "</button>"), d.deleteButton && d.restoreButton && (a = '<button type="button" class="tabledit-restore-button ' + d.buttons.restore["class"] + '" style="display: none; float: none;">' + d.buttons.restore.html + "</button></div>");
                            var o = '<div class="tabledit-toolbar ' + d.toolbarClass + '" style="display:flex;">\n <div class="' + d.groupClass + '" style="float: none;">' + t + e + "</div>\n" + n + "\n" + s + "\n" + a + "\n</div></div>";
