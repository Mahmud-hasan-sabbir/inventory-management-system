                ...
                <div class="card-body">
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" id="val-name" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Type role name.." value="{{old('name')}}">                                     
                                @error('name')
                        ...
                        <div class="form-group row pl-4">
                            ...
                            <div class="col-lg-3 role-management-checkbox">
                                <input class="form-check-input" type="checkbox" onclick="checksinglepermission('role-management-checkbox','management')" name="permissions[]" id="permission{{$permission->id}}" value="{{ $permission->id}}">
